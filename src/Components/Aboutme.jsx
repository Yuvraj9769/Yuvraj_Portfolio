      ...
      <div className="w-full h-auto px-2 py-1 my-5 flex flex-col gap-3 ">
        ...
        <div className="h-auto text-slate-50 flex flex-col gap-4 py-2">
          ...
          <p className="text-lg">
            ...
            with a strong passion for creating engaging and user-friendly
            digital experiences. I am eager to learn and refine my skills in
            coding, designing, and optimizing websites to deliver seamless
            solutions. With a fresh perspective and a drive to innovate, I am
            committed to researching and understanding industry trends to create
            captivating online platforms. My goal is to create dynamic and
            impactful websites that not only meet user needs but also contribute
