const Experience = () => {
  return (
    <div className="w-full h-auto px-2 py-1 my-5 flex flex-col gap-3 ">
      <p className="text-red-600  relative text-xl xl:after:h-[2px] xl:before:h-[2px] xl:text-2xl before:absolute before:bg-[#dadada] before:h-1 before:w-[35%] before:top-[50%] before:left-0  after:absolute after:bg-[#dadada] after:h-1 after:w-[35%] after:top-[50%] after:right-0 before:hidden sm:before:block after:hidden sm:after:block text-start sm:text-center">
        Experiences
      </p>
      <div className="h-auto text-slate-50 flex flex-col lg:flex-row justify-between items-center gap-4 py-2">
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg shadow-gray-400">
