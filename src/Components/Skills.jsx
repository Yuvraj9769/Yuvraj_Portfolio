  ...
  return (
    <div className="my-3 px-3 py-2 bg-black w-full h-auto flex flex-col gap-4">
      ...
      <div className="w-full flex flex-col md:flex-row md:flex-wrap gap-6 xl:gap-8 2xl:gap-10 items-center md:justify-center py-3 px-2 ">
        {skilldataInfo.map((e) => (
          <div
            className="px-4 py-3 rounded-lg shadow-lg shadow-gray-700 flex flex-col items-center justify-between  border hover:cursor-pointer hover:scale-95 duration-500 w-[280px] xl:gap-5 border-[#dadada] lg:py-4 h-[280px] lg:h-[250px]"
            key={e.id}
          >
            <img
              src={e.url}
